...
#import <IMQACrash/IMQACrashAppWithState.h>
#import <IMQACrash/IMQACrashClient.h>
#import <IMQACrash/IMQACrashConfiguration.h>
#import <IMQACrash/IMQACrashDevice.h>
#import <IMQACrash/IMQACrashDeviceWithState.h>
#import <IMQACrash/IMQACrashEndpointConfiguration.h>
#import <IMQACrash/IMQACrashError.h>
#import <IMQACrash/IMQACrashErrorTypes.h>
#import <IMQACrash/IMQACrashEvent.h>
#import <IMQACrash/IMQACrashMetadata.h>
#import <IMQACrash/IMQACrashPlugin.h>
#import <IMQACrash/IMQACrashSession.h>
#import <IMQACrash/IMQACrashStackframe.h>
#import <IMQACrash/IMQACrashThread.h>

/**
 * Static access to a IMQACrash Client, the easiest way to use IMQACrash in your app.
 */
@interface IMQACrash : NSObject <IMQACrashClassLevelMetadataStore>

/**
 * All IMQACrash access is class-level.  Prevent the creation of instances.
 */
- (instancetype _Nonnull )init NS_UNAVAILABLE NS_SWIFT_UNAVAILABLE("Use class methods to initialise IMQACrash.");

/**
 * Start listening for crashes.
 *
 * This method initializes IMQACrash with the configuration set in your Info.plist.
 *
 * If a IMQACrash apiKey string has not been added to your Info.plist or is empty, an
 ...
 * launches, these reports will be sent to your IMQACrash dashboard.
 */
+ (IMQACrashClient *_Nonnull)start;

/**
 * Start listening for crashes.
 *
 * This method initializes IMQACrash with the default configuration and the provided
 * apiKey.
 *
 ...
 * launches, these reports will be sent to your IMQACrash dashboard.
 *
 * @param apiKey  The API key from your IMQACrash dashboard.
 */
+ (IMQACrashClient *_Nonnull)startWithApiKey:(NSString *_Nonnull)apiKey;

/**
 * Start listening for crashes.
 *
 * This method initializes IMQACrash with the provided configuration object.
 *
 ...
 */
+ (IMQACrashClient *_Nonnull)startWithConfiguration:(IMQACrashConfiguration *_Nonnull)configuration;
 ...
 * set in `IMQACrashConfiguration.maxBreadcrumbs`
 */
+ (NSArray<IMQACrashBreadcrumb *> *_Nonnull)breadcrumbs;
