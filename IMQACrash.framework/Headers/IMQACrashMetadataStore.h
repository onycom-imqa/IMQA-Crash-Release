...
// -----------------------------------------------------------------------------
// MARK: - <IMQACrashMetadataStore>
// -----------------------------------------------------------------------------

/**
 * An internal protocol defining methods a IMQACrash metadata store must implement.
 */
@protocol IMQACrashMetadataStore <NSObject>
...
// -----------------------------------------------------------------------------
// MARK: - <IMQACrashClassLevelMetadataStore>
// -----------------------------------------------------------------------------

/**
 * A class-level protocol supporting the MetadataStore interface
 */
@protocol IMQACrashClassLevelMetadataStore <NSObject>
